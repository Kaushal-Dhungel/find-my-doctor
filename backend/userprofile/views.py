...
class UserProfileView(APIView):
    ...
    def patch(self,request,*args, **kwargs):
        ...
        try:
            ...
            profile.fav_sport =  request.data.get('fav_sport',profile.fav_sport) 
            profile.fav_team =  request.data.get('fav_team',profile.fav_team) 
            profile.fav_movie =  request.data.get('fav_movie',profile.fav_movie) 
