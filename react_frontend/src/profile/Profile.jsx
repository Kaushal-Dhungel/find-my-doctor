                                            ...
                                            <div className="doctor_info_wrapper">
                                                <details>
                                                    ...
                                                    <div className="doc_info rounded shadow-sm">
                                                        ...
                                                        <p className = "doc_details"> <b>Favourite Sport/s:-</b> {item.fav_sport} </p>
                                                        <p className = "doc_details"> <b>Favourite Team/s:-</b> {item.fav_team} </p>
                                                        <p className = "doc_details"> <b>Favourite Movie/s:-</b> {item.fav_movie} </p>
                                                    </div>
                                                </details>
