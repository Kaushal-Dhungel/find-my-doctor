                  ...
                  <div className="container mt-5 box-element">
                    {
                      ...
                      <div>
                        ...
                        >
                          ...
                          <input name="fav_sport" className="form_input" type="text"
                            value={item.fav_sport} onChange={changeFn} placeholder="Favourite Sport/s, separate with comma" autoComplete="off"/>

                          <input name="fav_team" className="form_input" type="text"
                            value={item.fav_team} onChange={changeFn} placeholder="Favourite Team/s, separate with comma" autoComplete="off"/>

                          <input name="fav_movie" className="form_input" type="text"
                            value={item.fav_movie} onChange={changeFn} placeholder="Favourite Movie/s, separate with comma" autoComplete="off"/>
